...
<body>
	<div class="easyui-layout" data-options="fit:true" style="height:500px; border: 1px rgb(202, 196, 196) solid; border-radius: 5px;">
            ...
            <div class="easyui-tabs" data-options="fit:true,border:false">
                <div title="秒">
                    ...
                    <div class="line">
                        ...
                        周期从
                        <input class="easyui-numberspinner" style="width: 60px;" data-options="min:1,max:58" value="1" id="secondStart_0">
                        -
                        <input class="easyui-numberspinner" style="width: 60px;" data-options="min:2,max:59" value="2" id="secondEnd_0">
                        秒</div>
                    <div class="line">
                        <input type="radio" name="second" onclick="startOn(this)">
                        从
                        <input class="easyui-numberspinner" style="width: 60px;" data-options="min:0,max:59" value="0" id="secondStart_1">
                        秒开始,每
                        <input class="easyui-numberspinner" style="width: 60px;" data-options="min:1,max:59" value="1" id="secondEnd_1">
                        秒执行一次</div>
                    <div class="line">
                ...
                <div title="分钟">
                    ...
                    <div class="line">
                        ...
                        周期从
                        <input class="easyui-numberspinner" style="width: 60px;" data-options="min:1,max:58" value="1"
                            id="minStart_0">
                        -
                        <input class="easyui-numberspinner" style="width: 60px;" data-options="min:2,max:59" value="2"
                            id="minEnd_0">
                        分钟</div>
                    <div class="line">
                        <input type="radio" name="min" onclick="startOn(this)">
                        从
                        <input class="easyui-numberspinner" style="width: 60px;" data-options="min:0,max:59" value="0"
                            id="minStart_1">
                        分钟开始,每
                        <input class="easyui-numberspinner" style="width: 60px;" data-options="min:1,max:59" value="1"
                            id="minEnd_1">
                        分钟执行一次</div>
                    <div class="line">
                ...
                <div title="小时">
                    ...
                    <div class="line">
                        ...
                        周期从
                        <input class="easyui-numberspinner" style="width: 60px;" data-options="min:0,max:23" value="0"
                            id="hourStart_0">
                        -
                        <input class="easyui-numberspinner" style="width: 60px;" data-options="min:2,max:23" value="2"
                            id="hourEnd_1">
                        小时</div>
                    <div class="line">
                        ...
                        <input class="easyui-numberspinner" style="width: 60px;" data-options="min:0,max:23" value="0"
                            id="hourStart_1">
                        小时开始,每
                        <input class="easyui-numberspinner" style="width: 60px;" data-options="min:1,max:23" value="1"
                            id="hourEnd_1">
                        小时执行一次</div>
                    <div class="line">
                ...
                <div title="日">
                    ...
                    <div class="line">
                        ...
                        周期从
                        <input class="easyui-numberspinner" style="width: 60px;" data-options="min:1,max:31" value="1"
                            id="dayStart_0">
                        -
                        <input class="easyui-numberspinner" style="width: 60px;" data-options="min:2,max:31" value="2"
                            id="dayEnd_0">
                        日</div>
                    <div class="line">
                ...
                <div title="月">
                    ...
                    <div class="line">
                        ...
                        周期从
                        <input class="easyui-numberspinner" style="width: 60px;" data-options="min:1,max:12" value="1"
                            id="mouthStart_0">
                        -
                        <input class="easyui-numberspinner" style="width: 60px;" data-options="min:2,max:12" value="2"
                            id="mouthEnd_0">
                        月</div>
                    <div class="line">
                ...
                <div title="周">
                    ...
                    <div class="line">
                        ...
                        周期 从星期<input class="easyui-numberspinner" style="width: 60px;" data-options="min:1,max:7"
                            id="weekStart_0" value="1">
                        -
                        <input class="easyui-numberspinner" style="width: 60px;" data-options="min:2,max:7" value="2"
                            id="weekEnd_0"></div>
                    <div class="line">
                        <input type="radio" name="week" onclick="weekOfDay(this)">
                        第<input class="easyui-numberspinner" style="width: 60px;" data-options="min:1,max:4" value="1"
                            id="weekStart_1">
                        周 的星期<input class="easyui-numberspinner" style="width: 60px;" data-options="min:1,max:7"
                            id="weekEnd_1" value="1"></div>
                    <div class="line">
                        <input type="radio" name="week" onclick="lastWeek(this)">
                        本月最后一个星期<input class="easyui-numberspinner" style="width: 60px;" data-options="min:1,max:7"
                ...
                <div title="年">
                    ...
                    <div class="line">
                        ...
                        <input class="easyui-numberspinner" style="width: 90px;" data-options="min:2013,max:3000"
                            id="yearStart_0" value="2013">
                        -
                        <input class="easyui-numberspinner" style="width: 90px;" data-options="min:2014,max:3000"
                ...
                <table style="height: 100px;">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="v_second" class="col" value="*" readonly="readonly" style="width:50px"/>
                            </td>
                            <td>
                                <input type="text" name="v_min" class="col" value="*" readonly="readonly" style="width:50px"/>
                            </td>
                            <td>
                                <input type="text" name="v_hour" class="col" value="*" readonly="readonly" style="width:50px"/>
                            </td>
                            <td>
                                <input type="text" name="v_day" class="col" value="*" readonly="readonly" style="width:50px"/>
                            </td>
                            <td>
                                <input type="text" name="v_mouth" class="col" value="*" readonly="readonly" style="width:50px"/>
                            </td>
                            <td>
                                <input type="text" name="v_week" class="col" value="?" readonly="readonly" style="width:50px"/>
                            </td>
                            <td>
                                <input type="text" name="v_year" class="col" readonly="readonly" style="width:50px"/>
                            </td>
                        </tr>
                        <tr>
							<td>Cron 表达式:</td>
