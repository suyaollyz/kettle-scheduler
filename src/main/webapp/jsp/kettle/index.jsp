...
<head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/jsp/kettle/index.js"></script>
</head>
<body>
		...
		<div class="easyui-layout" fit="true">
			...
			<div data-options="region:'center'">
				<div class="easyui-layout" fit="true">
					...
					<div data-options="region:'south'" style="height:35px;text-align:center;padding:5px;background-color:#F4F4F4">
	...
	<!-- 运行状态编辑弹出窗口 -->
	<div id="runStatusEditWindow">
		<div class="easyui-layout" fit="true">
			<form id="runStatusEditForm" method="post">
			<div data-options="region:'center'" style="padding-top:10px">
				<input type="hidden" id="runStatusEditJobId" name="jobId" />
				运行状态：
				<select class="easyui-combobox" id="e_runStatus" name="runStatus" style="width:200px">
				    <option value="0">正常结束</option>
				    <!-- <option value="1">运行中</option> -->
				    <option value="2">异常结束</option>
				</select>
			</div>
			</form>
			<div data-options="region:'south'" style="height:35px;text-align:center;padding:5px;background-color:#F4F4F4">
				<a id="runStatusEidtSaveBtn" href="#">保存</a>
			</div>
		</div>
	</div>
	<!-- 表达式编辑弹出窗口 -->
